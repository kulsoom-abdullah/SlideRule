...
#respective scores = 0.616040955631, 0.616040955631, 0.821387940842, 0.892491467577
#0.990898748578 score if I use all the data, rbf with C=10000 where training time: 95.936 s
